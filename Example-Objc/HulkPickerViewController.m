...
#import "HulkPickerViewController.h"
#import "FSCalendar.h"
#import "FSCalendarExtensions.h"

#import "HulkCalendarCell.h"

@interface HulkPickerViewController ()<FSCalendarDataSource,FSCalendarDelegate,FSCalendarDelegateAppearance>
...
@implementation HulkPickerViewController
...
- (void)loadView
{
    ...
    [calendar registerClass:[HulkCalendarCell class] forCellReuseIdentifier:@"cell"];
...
{
    HulkCalendarCell *cell = [calendar dequeueReusableCellWithIdentifier:@"cell" forDate:date atMonthPosition:monthPosition];
    return cell;
}
...
- (void)configureCell:(__kindof FSCalendarCell *)cell forDate:(NSDate *)date atMonthPosition:(FSCalendarMonthPosition)position
{
    HulkCalendarCell *rangeCell = cell;
